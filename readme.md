...
2. Open directory **source\App\Web\Frontend** in command line and execute **npm run restore**.

3. Open directory **source\App\Web** in command line and execute **dotnet run**.
...
3. Open directory **source\App\Web\Frontend** in command line and execute **npm run restore**.
...
4. Set **Solution.App.Web** as startup project.
